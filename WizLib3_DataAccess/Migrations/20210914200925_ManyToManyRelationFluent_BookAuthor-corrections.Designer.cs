...
namespace WizLib3_DataAccess.Migrations
{
    ...
    [Migration("20210914200925_ManyToManyRelationFluent_BookAuthor-corrections")]
    partial class ManyToManyRelationFluent_BookAuthorcorrections
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WizLib3_Model.Models.Category", b =>
                {
            ...
            modelBuilder.Entity("WizLib3_Model.Models_Fluent.Fluent_BookAuthor", b =>
                {
                    b.Property<int>("Book_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WizLib3_Model.Models_Fluent.Fluent_BookAuthor", b =>
                {
                    ...
                    b.HasOne("WizLib3_Model.Models_Fluent.Fluent_Book", "Fluent_Book")
                        .WithMany("Fluent_BookAuthors")
                        .HasForeignKey("Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
